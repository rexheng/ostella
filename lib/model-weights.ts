...
// TIER THRESHOLDS
//
// Calibrated 2026-04-10 against the deterministic 82-patient synthetic
// cohort generated by scripts/generate-patients.ts (seed=42), scored with
// the literature-verified WEIGHTS above and the
// "collapse_stage_to_reference_when_on_hrt" + "only_apply_when_peri_or_earlier"
// interaction rules. Run scripts/check-cohort-distribution.ts to reproduce.
//
// With these thresholds the cohort distributes as 55% low / 30% moderate /
// 15% high — the target spec range — and Sarah Chen (p-001, RR≈2.58) clears
// the high tier. The provisional placeholder (moderate=1.5, high=3.5) was
// dropped because the verified weights produce smaller relative-risk
// magnitudes than the plan's initial back-of-envelope examples assumed; at
// high=3.5 only 1 of 82 patients would have been flagged as high-risk and
// Sarah would have been moderate.
//
// Do not deploy to patients until this calibration is re-validated against
// real population data and documented in docs/model-calibration.md §7.1.
// ===========================================================================
